              ...
              <div className="col-lg-6">
                ...
                <div className="about-thumb-wrap">
                  <div className="about-thumb-small">
                    <img src="assets/images/service/pixlr-bg-result98656.png" alt="" height={300} />
                  </div>
                  <div className="about-thumb-big">
                    <img src="assets/images/service/pixlr-bg-result (3).png" alt="" height={270} width={270} />
                  </div>
              ...
              <div className="col-lg-6">
                ...
                <div className="about-content">
                  <div className="section-title">
                    <h3 className="sub-title">Structured Cabling and Networking</h3>
                    <h2 className="title">Structured cabling is critical backbone that drives todays communication systesms.</h2>
                  </div>
                  <p>Our teams of expert at LancolaTech designs and installs cost effective communications
                    systems built and customized to meet the requirements and demands of your growing business.</p>
                </div>
                {/* About Content End */}
              </div>
            </div>
