              ...
              <div className="col-lg-6">
                ...
                <div className="about-thumb-wrap">
                  <div className="about-thumb-small">
                    <img src="assets/images/service/pixlr-bg-result567.png" alt="" height={300} />
                  </div>
                  <div className="about-thumb-big">
                    <img src="assets/images/service/32-350-882-V01 (1).png" alt="" height={225} width={300} />
                  </div>
              ...
              <div className="col-lg-6">
                ...
                <div className="about-content">
                  <div className="section-title">
                    <h3 className="sub-title">Computer Solutions</h3>
                    <h2 className="title">We offer a variety of computer solution ranging from:</h2>
                  </div>
                  <p><strong>Antivirus installation
                      <br />
